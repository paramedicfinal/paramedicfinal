...
public class dispaly_modify_delete_paramedic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dispaly_modify_delete_paramedic);
    ...
    protected void onStart() {
        ...
        databaseParamedic.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ParamedicList adapter = new ParamedicList(dispaly_modify_delete_paramedic.this, paramedicsList);
